...
time0=time.time()
mcslave=mc.MC(0,LMatrix,pos=pos,S=Spin,D=D,bondList=bondList,T=0.2,Lx=32,Ly=32,Lz=1,ki_s=0,ki_t=0,ki_overLat=[0,0,0],h=0.0,dipoleAlpha=0.0,On=1,spinFrame=500)
data=mcslave.mainLoopViaCLib_On(nsweep=500,nthermal=20000,ninterval=0,algo='Metropolis',On=2,flunc=0.0)
