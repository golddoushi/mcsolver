...
time0=time.time()
mcslave=mc.MC(0,LMatrix,pos=pos,S=Spin,D=D,bondList=bondList,T=0.4,Lx=6,Ly=6,Lz=1,ki_s=0,ki_t=0,ki_overLat=[0,0,0],orbGroupList=[[0]],groupInSC=True,h=0.0,dipoleAlpha=0.0,On=3,spinFrame=0)
data=mcslave.mainLoopViaCLib_On(nsweep=40000,nthermal=20000,ninterval=1,algo='Wolff',On=3,flunc=0.0)
